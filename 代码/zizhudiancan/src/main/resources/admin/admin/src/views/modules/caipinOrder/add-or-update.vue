    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="配送员名称" prop="caipinOrderCourierName">
                       <el-input v-model="ruleForm.caipinOrderCourierName"
                                 placeholder="配送员名称" clearable  :readonly="ro.caipinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="配送员名称" prop="caipinOrderCourierName">
                           <el-input v-model="ruleForm.caipinOrderCourierName"
                                     placeholder="配送员名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="caipinOrderText">
                        <el-input type="textarea"  :readonly="ro.caipinOrderText" v-model="ruleForm.caipinOrderText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinOrderText" label="备注" prop="caipinOrderText">
                            <span v-html="ruleForm.caipinOrderText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
